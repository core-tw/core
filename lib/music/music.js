...
module.exports = class {
    constructor(client) {
        ...
        this.player.on('connectionCreate', (queue) => {
    ...
    async play(msg, song) {
        ...
        queue.setVolume(this.presetVolume);
        return true;
    }
    ...
    async filter(msg, f) {
        ...
        options[f] = !queue.getFiltersEnabled().includes(f);
